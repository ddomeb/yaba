...
class AccountViewUnitTests(APITestCase):
    def setUp(self):
        ...
        dummy_account = Account(
            name="testaccount", description="testaccount", balance=1000, type="account", owner=self.user
        )
        dummy_account.save()
    ...
    def test_list_accounts(self):
        ...
        self.assertEqual(response.data[0]["name"], "testaccount", "Test account is listed")
